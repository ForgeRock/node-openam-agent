...
OpenAMClient.prototype.authenticate = function (username, password, realm, service, module, noSession) {
    ...
    return request.post(this.serverAddress + '/json' + realm + '/authenticate', {
        headers: {
            'host' : this.hostname,
 ...
 */
OpenAMClient.prototype.logout = function (sessionId, cookieName, realm) {
    if (!sessionId)
        return Promise.resolve();

    var headers = {};
    console.log('Logout cookie: ' + cookieName)
    headers[cookieName] = sessionId;
    headers['host'] = this.hostname; 
    headers['Content-Type'] = 'application/json',
    headers['Accept-API-Version'] = 'resource=1.1'
    

    return request.post(this.serverAddress + '/json' + realm + '/sessions', {
        headers: headers,
        qs: {
            _action: 'logout'
        }
 ...
 * @return {string}
 */
OpenAMClient.prototype.getLoginUrl = function (goto, realm) {
 ...
 */
OpenAMClient.prototype.getPolicyDecision = function (params, realm, sessionId, cookieName) {

    var headers = {};
    headers[cookieName] = sessionId;
    headers['host'] = this.hostname; 

    return request.post(this.serverAddress + '/json' + realm + '/policies', {
        headers: headers,
        qs: {
            _action: 'evaluate'
        },
...
OpenAMClient.prototype.getProfile = function (userId, realm, sessionId, cookieName) {
    //noinspection JSValidateTypes
    return request.get(this.serverAddress + '/json' + realm + '/users/' + userId, {
        headers: {
            host: this.hostname,
