...
function PolicyAgent(options) {
    ...
    /**
     * Config options
     * @type {{serverUrl: string, username: string, password: string, realm: string, notificationsEnabled?: boolean, notificationRoute?: string, appUrl?: string, errorPage: Function, logger?: winston~Logger, logLevel?: string, noInit?: boolean, sessionCache?: Cache, openAMClient?: (OpenAMClient|*)}}
     */
